        ...
        <div className="flex flex-col lg:flex-row items-center justify-between gap-y-4 lg:gap-y-0 py-4">
          ...
          <div className="flex-shrink-0 w-full lg:w-auto flex justify-between items-center">
            ...
            <div className={`flex items-center lg:hidden transition-all duration-300 ${showMobileHamburger ? 'space-x-0' : 'space-x-2'}`}>
              ...
              <a href="https://teamsideline.com/sites/aikaneohana/schedules" target="_blank" rel="noopener noreferrer" className="nav-link text-gray-700 hover:text-teal-800 text-sm font-medium">Schedules</a>
              <span className="text-gray-300">|</span>
          ...
          <div className="w-full lg:w-auto">
            <div className="hidden lg:flex flex-col lg:flex-row items-center justify-center lg:justify-end gap-y-4 lg:gap-y-0 w-full">
              <div className="flex items-center ml-10 space-x-4">
                ...
                <a href="https://teamsideline.com/sites/aikaneohana/schedules" target="_blank" rel="noopener noreferrer" className="nav-link relative group overflow-hidden text-gray-700 hover:text-gray-900 px-3 py-2 rounded-md text-sm font-medium">
